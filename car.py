...
while True:
    ...
    acceleration_status = message_string_received[:4]

    if acceleration_status > 0.5: acceleration_status = 0.5

    speed_left = (acceleration_status*200) * message_string_received[6]
    speed_right = (acceleration_status*200) * message_string_received[5]
